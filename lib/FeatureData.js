...
exports.TitleKnowlege = function TitleKnowlege (ToFixed, From, To, kIndex) {
    ...
    if (ToFixed !== To) {
        ...
        for (rIndex; rIndex <= Knowlege.LPMAX; rIndex++) {
            if (rIndex >= (tmp.length - 1)) {
                break;
            } else if (Knowlege.LocationPrefixes[exports.PrefixCache(tmp, rIndex)]) {
                return 1;
            }
        }
    } return 0;
...
exports.LocationSuffix = function LocationSuffix (ToFixed, From, To, kIndex) {
    ...
    if (ToFixed !== To) {
        ...
        for (rIndex; rIndex <= Knowlege.LSMAX; rIndex++) {
            if (rIndex >= (tmp.length - 1)) {
                break;
            } else if (Knowlege.LocationSuffixes[exports.SuffixCache(tmp, rIndex)]) {
                return 1;
            }
        }
    } return 0; 
